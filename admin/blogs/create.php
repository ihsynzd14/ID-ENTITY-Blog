...
$sql = "SELECT * FROM users";    // ..ottengo quel determinato utente
        ...
        <?php include(ROOT_PATH . "/app/includes/adminSidebar.php"); ?>
            ...
            <div class="admin-content">
                ...
                <div class="content">
                    ...
                    <h2 class="page-title">Aggiungi Blog</h2>
                    ...
                    <form action="create.php" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <button type="submit" name="add-blog" class="btn btn-big"style="background:#910477;">Aggiungi Blog</button>
                        </div>
                    </form>
